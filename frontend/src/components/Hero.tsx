...
const Hero = () => {
    return (
      <div className="bg-green-900 text-white h-96 flex flex-col items-center justify-center">
        <div className="text-center">
          ...
          <div className="mt-8 flex justify-center space-x-4">
            <button className="bg-yellow-400 text-black font-bold py-2 px-6 rounded-full">Find my match</button>
